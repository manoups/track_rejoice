package one.breece.track_rejoice.command.configuration
...
@EnableJpaRepositories(
    basePackages = ["one.breece.track_rejoice.command.repository", "one.breece.track_rejoice.security.repository"],
