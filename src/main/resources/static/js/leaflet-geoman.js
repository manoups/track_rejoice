(() => {
    ...
    var rh = (t, e, i, r) => {
        if (e && typeof e == "object" || typeof e == "function") for (let n of th(e)) !ih.call(t, n) && n !== i && hr(t, n, {
            get: () => e[n],
            enumerable: !(r = Ql(e, n)) || r.enumerable
        });
        return t
    };
    var xt = (t, e, i) => (i = t != null ? Wl(eh(t)) : {}, rh(e || !t || !t.__esModule ? hr(i, "default", {
        value: t,
        enumerable: !0
    }) : i, t));
    var pr = S((C_, cr) => {
    ...
    var qt = S((N_, Dr) => {
        var Bh = oi(), Th = typeof self == "object" && self && self.Object === Object && self,
    ...
    var qr = S((F_, Gr) => {
        var Ar = Oe(), Ir = Object.prototype, Ah = Ir.hasOwnProperty, Ih = Ir.toString,
            pe = Ar ? Ar.toStringTag : void 0;
    ...
    var Ht = S((U_, Ur) => {
        var Fr = Oe(), Fh = qr(), Vh = zr(), Uh = "[object Null]", Kh = "[object Undefined]",
            Vr = Fr ? Fr.toStringTag : void 0;
    ...
    var Ae = S((j_, jr) => {
        var Xh = Ht(), Yh = Bt(), Jh = "[object AsyncFunction]", $h = "[object Function]",
            Zh = "[object GeneratorFunction]", Wh = "[object Proxy]";
    ...
    var tn = S((J_, Qr) => {
        var au = Ae(), ou = $r(), lu = Bt(), hu = Wr(), uu = /[\\^$.*+?()[\]{}|]/g, cu = /^\[object .+?Constructor\]$/,
            pu = Function.prototype, fu = Object.prototype, du = pu.toString, gu = fu.hasOwnProperty,
    ...
    var Ge = S((_y, Fn) => {
        ...
        function xc(t, e, i) {
            e == "__proto__" && zn ? zn(t, e, {configurable: !0, enumerable: !0, value: i, writable: !0}) : t[e] = i
        }
    ...
    var Zn = S((ge, $t) => {
        var Tc = qt(), $n = typeof ge == "object" && ge && !ge.nodeType && ge,
            Xn = $n && typeof $t == "object" && $t && !$t.nodeType && $t, Rc = Xn && Xn.exports === $n,
            Yn = Rc ? Tc.Buffer : void 0, Jn = Yn ? Yn.allocUnsafe : void 0;
    ...
    var hs = S((wy, ls) => {
        var zc = Bt(), os = Object.create, Fc = function () {
            function t() {
            }
    ...
    var gi = S((Ry, vs) => {
        var Ls = ys(), ip = Nt(), bs = Object.prototype, rp = bs.hasOwnProperty, np = bs.propertyIsEnumerable,
            sp = Ls(function () {
                return arguments
            }()) ? Ls : function (t) {
    ...
    var _i = S((me, Wt) => {
        var mp = qt(), _p = Ps(), Ts = typeof me == "object" && me && !me.nodeType && me,
            Ss = Ts && typeof Wt == "object" && Wt && !Wt.nodeType && Wt, yp = Ss && Ss.exports === Ts,
            Bs = yp ? mp.Buffer : void 0, Lp = Bs ? Bs.isBuffer : void 0, bp = Lp || _p;
        Wt.exports = bp
    });
    var Os = S((qy, Ds) => {
        var vp = Ht(), kp = fi(), Mp = Nt(), xp = "[object Object]", wp = Function.prototype, Cp = Object.prototype,
            Rs = wp.toString, Ep = Cp.hasOwnProperty, Pp = Rs.call(Object);
    ...
    var Is = S((Ny, As) => {
        var Bp = Ht(), Tp = mi(), Rp = Nt(), Dp = "[object Arguments]", Op = "[object Array]", Ap = "[object Boolean]",
            Ip = "[object Date]", Gp = "[object Error]", qp = "[object Function]", Np = "[object Map]",
            zp = "[object Number]", Fp = "[object Object]", Vp = "[object RegExp]", Up = "[object Set]",
            Kp = "[object String]", jp = "[object WeakMap]", Hp = "[object ArrayBuffer]", Xp = "[object DataView]",
            Yp = "[object Float32Array]", Jp = "[object Float64Array]", $p = "[object Int8Array]",
            Zp = "[object Int16Array]", Wp = "[object Int32Array]", Qp = "[object Uint8Array]",
            tf = "[object Uint8ClampedArray]", ef = "[object Uint16Array]", rf = "[object Uint32Array]", Y = {};
        Y[Yp] = Y[Jp] = Y[$p] = Y[Zp] = Y[Wp] = Y[Qp] = Y[tf] = Y[ef] = Y[rf] = !0;
        Y[Dp] = Y[Op] = Y[Hp] = Y[Ap] = Y[Xp] = Y[Ip] = Y[Gp] = Y[qp] = Y[Np] = Y[zp] = Y[Fp] = Y[Vp] = Y[Up] = Y[Kp] = Y[jp] = !1;
    ...
    var zs = S((_e, Qt) => {
        var af = oi(), Ns = typeof _e == "object" && _e && !_e.nodeType && _e,
            ye = Ns && typeof Qt == "object" && Qt && !Qt.nodeType && Qt, of = ye && ye.exports === Ns,
            yi = of && af.process, lf = function () {
                try {
    ...
    var Qs = S((Xy, Ws) => {
        var wf = $s(), Cf = gi(), Ef = Zt(), Pf = _i(), Sf = vi(), Bf = Li(), Tf = Object.prototype,
            Rf = Tf.hasOwnProperty;

        function Df(t, e) {
            var i = Ef(t), r = !i && Cf(t), n = !i && !r && Pf(t), s = !i && !r && !n && Bf(t), a = i || r || n || s,
                o = a ? wf(t.length, String) : [], l = o.length;
    ...
    var pa = S((Wy, ca) => {
        var oa = pi(), Yf = Zn(), Jf = ns(), $f = as(), Zf = gs(), la = gi(), ha = Zt(), Wf = Cs(), Qf = _i(),
            td = Ae(), ed = Bt(), id = Os(), rd = Li(), ua = bi(), nd = aa();
        ...
        function sd(t, e, i, r, n, s, a) {
            ...
            if (d) {
                ...
                f = l, P || E || T ? ha(o) ? f = o : Wf(o) ? f = $f(o) : E ? (d = !1, f = Yf(l, !0)) : T ? (d = !1, f = Jf(l, !0)) : f = [] : id(l) || la(l) ? (f = o, la(o) ? f = nd(o) : (!ed(o) || td(o)) && (f = Zf(l))) : d = !1
            }
    ...
    var ga = S((Qy, da) => {
        ...
        function fa(t, e, i, r, n) {
            t !== e && ld(e, function (s, a) {
                if (n || (n = new ad), ud(s)) hd(t, e, a, i, fa, r, n); else {
    ...
    var Ca = S((nL, wa) => {
        var yd = Ma(), xa = ci(), Ld = Mi(), bd = xa ? function (t, e) {
            return xa(t, "toString", {configurable: !0, enumerable: !1, value: yd(e), writable: !0})
        } : Ld;
        wa.exports = bd
    });
    var Pa = S((sL, Ea) => {
    ...
    var Lo = S((Lb, yo) => {
        ...
        function Tg(t, e) {
            if (Eg(t)) return !1;
            var i = typeof t;
            return i == "number" || i == "symbol" || i == "boolean" || t == null || Pg(t) ? !0 : Bg.test(t) || !Sg.test(t) || e != null && t in Object(e)
        }
    ...
    var Oo = S((xb, Do) => {
        var So = Oe(), Fg = Po(), Vg = Zt(), Ug = ze(), Kg = 1 / 0, Bo = So ? So.prototype : void 0,
        ...
        (function (t, e) {
            ...
            function t(_, x, b, R, D) {
                (function O(A, q, h, c, p) {
                    for (; c > h;) {
                        if (c - h > 600) {
                            var y = c - h + 1, g = q - h + 1, k = Math.log(y), C = .5 * Math.exp(2 * k / 3),
            ...
            return r.prototype.all = function () {
                ...
                if (this.data.children.length) if (this.data.height === b.height) this._splitRoot(this.data, b); else {
                ...
                for (var R, D, O, A, q, h, c, p = 1 / 0, y = 1 / 0, g = x; g <= b - x; g++) {
                    var k = a(_, 0, g, this.toBBox), C = a(_, g, b, this.toBBox),
    ...
    var zi = S(Q => {
                    ...
                    if (a = P ? u.geometries[b] : u, a !== null) {
                        ...
                        switch (f = i && (O === "Polygon" || O === "MultiPolygon") ? 1 : 0, O) {
                            ...
                            case"GeometryCollection":
                                for (r = 0; r < a.geometries.length; r++) if (Ce(a.geometries[r], e, i) === !1) return !1;
                                break;
                            default:
        ...
        function al(t, e) {
            if (t.type === "Feature") e(t, 0); else if (t.type === "FeatureCollection") for (var i = 0; i < t.features.length && e(t.features[i], i) !== !1; i++) ;
        }
        ...
        function Ni(t, e) {
            var i, r, n, s, a, o, l, u, f, d, P = 0, E = t.type === "FeatureCollection", T = t.type === "Feature",
            ...
            for (i = 0; i < G; i++) {
                for (o = E ? t.features[i].geometry : T ? t.geometry : t, u = E ? t.features[i].properties : T ? t.properties : {}, f = E ? t.features[i].bbox : T ? t.bbox : void 0, d = E ? t.features[i].id : T ? t.id : void 0, l = o ? o.type === "GeometryCollection" : !1, a = l ? o.geometries.length : 1, n = 0; n < a; n++) {
                    ...
                    switch (s.type) {
                        ...
                        case"GeometryCollection": {
                            for (r = 0; r < s.geometries.length; r++) if (e(s.geometries[r], P, u, f, d) === !1) return !1;
                            break
                        }
                        default:
                            throw new Error("Unknown Geometry Type")
        ...
        function Ke(t, e) {
            Ni(t, function (i, r, n, s, a) {
                ...
                switch (o) {
                    ...
                    case"LineString":
                    case"Polygon":
                        return e(nt.feature(i, n, {bbox: s, id: a}), r, 0) === !1 ? !1 : void 0
                }
                var l;
                switch (o) {
                    case"MultiPoint":
                ...
                if (i.geometry !== null) {
                    ...
                    switch (s) {
                        case"LineString":
                            ...
                            break;
                        case"Polygon":
                            for (var o = 0; o < a.length; o++) if (e(nt.lineString(a[o], i.properties), r, n, o) === !1) return !1;
                            break
                    }
                }
            })
        ...
        function Fm(t, e) {
            ...
            var i = e.featureIndex || 0, r = e.multiFeatureIndex || 0, n = e.geometryIndex || 0,
                s = e.segmentIndex || 0, a = e.properties, o;
            switch (t.type) {
                case"FeatureCollection":
        ...
        function Vm(t, e) {
            if (e = e || {}, !nt.isObject(e)) throw new Error("options is invalid");
            var i = e.featureIndex || 0, r = e.multiFeatureIndex || 0, n = e.geometryIndex || 0, s = e.coordIndex || 0,
                a = e.properties, o;
            switch (t.type) {
                case"FeatureCollection":
                    i < 0 && (i = t.features.length + i), a = a || t.features[i].properties, o = t.features[i].geometry;
    ...
    var Ki = S((Pv, Ui) => {
        var kt = Qo(), cl = qi(), pl = zi(), re = hl().default, Km = pl.featureEach, Cv = pl.coordEach, Ev = cl.polygon,
        ...
        function fl(t) {
            ...
            return e.insert = function (i) {
                ...
                var r;
                if (i.bbox) r = i.bbox; else if (Array.isArray(i) && i.length === 4) r = i; else if (Array.isArray(i) && i.length === 6) r = [i[0], i[1], i[3], i[4]]; else if (i.type === "Feature") r = re(i); else if (i.type === "FeatureCollection") r = re(i); else throw new Error("invalid geojson");
    ...
    var ur = {
        ...
        repository: {type: "git", url: "git://github.com/geoman-io/leaflet-geoman.git"},
        author: {name: "Geoman.io", email: "sales@geoman.io", url: "http://geoman.io"},
        license: "MIT",
    ...
    var Na = {
        ...
        actions: {finish: "Beenden", cancel: "Abbrechen", removeLastVertex: "Letzten Vertex l\xF6schen"},
        buttonTitles: {
    ...
    var za = {
        ...
        actions: {finish: "Termina", cancel: "Annulla", removeLastVertex: "Rimuovi l'ultimo vertice"},
        buttonTitles: {
    ...
    var Fa = {
        ...
        actions: {finish: "Selesai", cancel: "Batal", removeLastVertex: "Hilangkan Vertex Terakhir"},
        buttonTitles: {
    ...
    var Va = {
        ...
        actions: {finish: "Termin\u0103", cancel: "Anuleaz\u0103", removeLastVertex: "\u0218terge ultimul Vertex"},
        buttonTitles: {
    ...
    var Ka = {
        ...
        actions: {finish: "Finalizar", cancel: "Cancelar", removeLastVertex: "Eliminar \xFAltimo v\xE9rtice"},
        buttonTitles: {
    ...
    var ja = {
        ...
        actions: {finish: "Bewaar", cancel: "Annuleer", removeLastVertex: "Verwijder laatste punt"},
        buttonTitles: {
    ...
    var Ha = {
        ...
        actions: {finish: "Terminer", cancel: "Annuler", removeLastVertex: "Retirer le dernier sommet"},
        buttonTitles: {
    ...
    var Ja = {
        ...
        actions: {finish: "Finalizar", cancel: "Cancelar", removeLastVertex: "Remover \xFAltimo v\xE9rtice"},
        buttonTitles: {
    ...
    var xi = {
        ...
        actions: {finish: "Terminar", cancel: "Cancelar", removeLastVertex: "Remover \xDAltimo V\xE9rtice"},
        buttonTitles: {
            drawMarkerButton: "Desenhar Marcador",
            drawPolyButton: "Desenhar Pol\xEDgonos",
    ...
    var $a = {
        ...
        actions: {finish: "Zako\u0144cz", cancel: "Anuluj", removeLastVertex: "Usu\u0144 ostatni wierzcho\u0142ek"},
        buttonTitles: {
    ...
    var Za = {
        ...
        actions: {finish: "Slutf\xF6r", cancel: "Avbryt", removeLastVertex: "Ta bort sista h\xF6rnet"},
        buttonTitles: {
    ...
    var Qa = {
        ...
        actions: {finish: "Befejez\xE9s", cancel: "M\xE9gse", removeLastVertex: "Utols\xF3 pont elt\xE1vol\xEDt\xE1sa"},
        buttonTitles: {
    ...
    var to = {
        ...
        actions: {finish: "Afslut", cancel: "Afbryd", removeLastVertex: "Fjern sidste punkt"},
        buttonTitles: {
    ...
    var eo = {
        ...
        actions: {finish: "Fullf\xF8r", cancel: "Kanseller", removeLastVertex: "Fjern forrige punkt"},
        buttonTitles: {
    ...
    var no = {
        ...
        actions: {finish: "Bitir", cancel: "\u0130ptal", removeLastVertex: "Son k\xF6\u015Feyi kald\u0131r"},
        buttonTitles: {
    ...
    var so = {
        ...
        actions: {finish: "Dokon\u010Dit", cancel: "Zru\u0161it", removeLastVertex: "Zru\u0161it posledn\xED akci"},
        buttonTitles: {
    ...
    var oo = {
        ...
        actions: {finish: "Valmis", cancel: "Peruuta", removeLastVertex: "Poista viimeinen osuus"},
        buttonTitles: {
    ...
    var _g = {
        _globalEditModeEnabled: !1, enableGlobalEditMode(t) {
            let e = {...t};
    ...
    var yg = {
        _globalDragModeEnabled: !1, enableGlobalDragMode() {
    ...
    var bg = {
        _globalRotateModeEnabled: !1, enableGlobalRotateMode() {
    ...
    var kg = () => ({
        _lastEvents: {keydown: void 0, keyup: void 0, current: void 0}, _initKeyListener(t) {
    ...
    function am(t, e, i) {
        let r = {a: L.CRS.Earth.R, b: 63567523142e-4, f: .0033528106647474805}, {a: n, b: s, f: a} = r, o = t.lng,
            l = t.lat, u = i, f = Math.PI, d = e * f / 180, P = Math.sin(d), E = Math.cos(d),
            T = (1 - a) * Math.tan(l * f / 180), G = 1 / Math.sqrt(1 + T * T), _ = T * G, x = Math.atan2(T, E),
            b = G * P, R = 1 - b * b, D = R * (n * n - s * s) / (s * s),
            O = 1 + D / 16384 * (4096 + D * (-768 + D * (320 - 175 * D))),
            A = D / 1024 * (256 + D * (-128 + D * (74 - 47 * D))), q = u / (s * O), h = 2 * Math.PI, c, p, y;
        for (; Math.abs(q - h) > 1e-12;) {
            c = Math.cos(2 * x + q), p = Math.sin(q), y = Math.cos(q);
            let B = A * p * (c + A / 4 * (y * (-1 + 2 * c * c) - A / 6 * c * (-3 + 4 * p * p) * (-3 + 4 * c * c)));
            h = q, q = u / (s * O) + B
        }
        let g = _ * p - G * y * E, k = Math.atan2(_ * y + G * p * E, (1 - a) * Math.sqrt(b * b + g * g)),
            C = Math.atan2(p * P, G * y - _ * p * E), m = a / 16 * R * (4 + a * (4 - 3 * R)),
            v = C - (1 - m) * a * b * (q + m * p * (c + m * y * (-1 + 2 * c * c))), w = o + v * 180 / f,
            M = k * 180 / f;
        return L.latLng(w, M)
    }

    function Ei(t, e, i, r, n = !0) {
        let s, a, o, l = [];
        for (let u = 0; u < i; u += 1) {
            if (n) s = u * 360 / i + r, a = am(t, s, e), o = L.latLng(a.lng, a.lat); else {
    ...
    function om(t, e, i) {
        e = (e + 360) % 360;
        let r = Math.PI / 180, n = 180 / Math.PI, {R: s} = L.CRS.Earth, a = t.lng * r, o = t.lat * r, l = e * r,
            u = Math.sin(o), f = Math.cos(o), d = Math.cos(i / s), P = Math.sin(i / s),
            E = Math.asin(u * d + f * P * Math.cos(l)), T = a + Math.atan2(Math.sin(l) * P * f, d - u * Math.sin(E));
        T *= n;
    ...
    function ke(t, e, i) {
        let r = t.latLngToContainerPoint(e), n = t.latLngToContainerPoint(i),
    ...
    var lm = L.Class.extend({
        includes: [uo, co, po, fo, Rt], initialize(t) {
    ...
    var hm = L.Control.extend({
        includes: [Rt], options: {position: "topleft", disableByOtherButtons: !0}, initialize(t) {
            ...
            t && t.preventDefault(), !this._button.disabled && (this._button.onClick(t, {
                button: this,
                event: t
            }), this._clicked(t), this._button.afterClick(t, {button: this, event: t}))
        }, _makeButton(t) {
            ...
            let n = L.DomUtil.create("div", `leaflet-pm-actions-container ${e}`, i), s = t.actions, a = {
                cancel: {
                    text: V("actions.cancel"), title: V("actions.cancel"), onClick() {
                        this._triggerClick()
                    }
                },
                finishMode: {
                    text: V("actions.finish"), title: V("actions.finish"), onClick() {
                        this._triggerClick()
                    }
                },
                removeLastVertex: {
                ...
                finish: {
                    text: V("actions.finish"), title: V("actions.finish"), onClick(l) {
            ...
            t._preparedActions = s.map(l => {
                ...
                if (a[u]) f = a[u]; else if (l.text) f = l; else return f;
    ...
    var um = L.Class.extend({
        options: {
            ...
            if (e) typeof e != "object" && (e = {name: e}); else throw new TypeError("Button has no name");
            ...
            }), t.toggle !== !1 && (t.toggle = !0), t.block && (t.block = t.block.toLowerCase()), (!t.block || t.block === "draw") && (t.block = ""), t.className ? t.className.indexOf("control-icon") === -1 && (t.className = `control-icon ${t.className}`) : t.className = "control-icon";
            let e = {
                tool: t.block,
    ...
    var cm = {
        _initSnappableMarkers() {
            ...
            let s = this.options.snapDistance, a = {
                marker: e,
                shape: this._shape,
                snapLatLng: n,
                segment: i.segment,
            ...
            let i = this._map, r = e instanceof L.Marker || e instanceof L.CircleMarker, n = e instanceof L.Polygon,
                s = t;
            if (r) {
                let a = e.getLatLng();
            ...
            if (this.options.snapVertex) {
                let a = this._getDistance(e, i, n), o = this._getDistance(e, r, n), l = a < o ? i : r,
                    u = a < o ? a : o;
            ...
            let n = t.getMaxZoom();
            n === 1 / 0 && (n = t.getZoom());
            let s = t.project(e, n), a = t.project(i, n), o = t.project(r, n),
    ...
    var pm = L.Class.extend({
        ...
        options: {
            ...
            rectangleAngle: 0,
            textOptions: {text: null, focusAfterDraw: null, removeIfEmpty: null, className: null},
            snapVertex: !0
        },
        setOptions(t) {
    ...
    function zt(t) {
        ...
        if (t.type === "Feature" ? i = t.geometry : i = t, i.type === "LineString") e = [i.coordinates]; else if (i.type === "MultiLineString") e = i.coordinates; else if (i.type === "MultiPolygon") e = [].concat.apply([], i.coordinates); else if (i.type === "Polygon") e = i.coordinates; else throw new Error("Input must be a LineString, MultiLineString, Polygon, or MultiPolygon Feature or Geometry");
    ...
    function fm(t, e, i, r, n, s, a, o) {
        var l, u, f, d, P, E = {x: null, y: null, onLine1: !1, onLine2: !1};
    ...
    X.Line = X.extend({
        initialize(t) {
            ...
            let e = this._layer.getLatLngs(),
                i = t[t.length - 1], {indexPath: r} = L.PM.Utils.findDeepMarkerIndex(t, i);
            ...
            let e = new L.Marker(t, {draggable: !1, icon: L.divIcon({className: "marker-icon"})});
    ...
    X.Rectangle = X.extend({
        initialize(t) {
            ...
            let t = Pi(this._startMarker.getLatLng(), this._map), e = Pi(this._hintMarker.getLatLng(), this._map),
    ...
    X.CircleMarker = X.extend({
        initialize(t) {
            ...
            let t = this._centerMarker.getLatLng(), e = this._hintMarker.getLatLng(),
            ...
            this._hintMarker._snapped || this._hintMarker.setLatLng(t.latlng);
            let e = this._hintMarker.getLatLng(),
                i = new this._BaseCircleClass(e, {radius: this._defaultRadius, ...this.options.pathOptions});
                ...
                if (a = P ? u.geometries[b] : u, a !== null) {
                    ...
                    switch (f = i && (O === "Polygon" || O === "MultiPolygon") ? 1 : 0, O) {
                        ...
                        case"MultiPolygon":
                            ...
                            break;
                        case"GeometryCollection":
                            for (r = 0; r < a.geometries.length; r++) if (xe(a.geometries[r], e, i) === !1) return !1;
                            break;
                        default:
                            throw new Error("Unknown Geometry Type")
                    }
    ...
    function ie(t, e) {
        dm(t, function (i, r, n, s, a) {
            ...
            switch (o) {
                ...
                case"LineString":
                case"Polygon":
                    return e(Ot(i, n, {bbox: s, id: a}), r, 0) === !1 ? !1 : void 0
            }
            var l;
            switch (o) {
                case"MultiPoint":
    ...
    function ym(t, e) {
        var i = t[0], r = t[1], n = e[0], s = e[1], a = i < n ? i : n, o = r < s ? r : s, l = i > n ? i : n,
            u = r > s ? r : s;
        return [a, o, l, u]
    }
    ...
    function dl(t, e) {
        ...
        var n = i[0][0], s = i[0][1], a = i[1][0], o = i[1][1], l = r[0][0], u = r[0][1], f = r[1][0], d = r[1][1],
            P = (d - u) * (a - n) - (f - l) * (o - s), E = (f - l) * (s - u) - (d - u) * (n - l),
            T = (a - n) * (s - u) - (o - s) * (n - l);
        if (P === 0) return null;
        var G = E / P, _ = T / P;
        if (G >= 0 && G <= 1 && _ >= 0 && _ <= 1) {
    ...
    function Hm(t, e, i) {
        i === void 0 && (i = {});
        var r = rt(t), n = rt(e), s = lt(n[1] - r[1]), a = lt(n[0] - r[0]), o = lt(r[1]), l = lt(n[1]),
    ...
    function je(t, e, i) {
        if (i === void 0 && (i = {}), i.final === !0) return $m(t, e);
        var r = rt(t), n = rt(e), s = lt(r[0]), a = lt(n[0]), o = lt(r[1]), l = lt(n[1]),
    ...
    function He(t, e, i, r) {
        r === void 0 && (r = {});
        var n = rt(t), s = lt(n[0]), a = lt(n[1]), o = lt(i), l = Zo(e, r.units),
    ...
    function Zm(t, e, i) {
        ...
        return ie(t, function (s) {
            for (var a = ot(s), o = 0; o < a.length - 1; o++) {
                ...
                var f = Ct(l, u, i), d = Math.max(l.properties.dist, u.properties.dist), P = je(l, u),
                    E = He(e, d, P + 90, i), T = He(e, d, P - 90, i),
    ...
    function ne(t, e, i) {
        ...
        if (a && Qm(r, a) === !1) return !1;
        s === "Polygon" && (o = [o]);
        for (var l = !1, u = 0; u < o.length && !l; u++) if (kl(r, o[u][0], i.ignoreBoundary)) {
    ...
    function kl(t, e, i) {
        ...
        for (var n = 0, s = e.length - 1; n < e.length; s = n++) {
            var a = e[n][0], o = e[n][1], l = e[s][0], u = e[s][1],
    ...
    function t_(t, e, i) {
        ...
        for (var r = rt(t), n = ot(e), s = 0; s < n.length - 1; s++) {
            var a = !1;
            if (i.ignoreEndVertices && (s === 0 && (a = "start"), s === n.length - 2 && (a = "end"), s === 0 && s + 1 === n.length - 1 && (a = "both")), e_(n[s], n[s + 1], r, a, typeof i.epsilon > "u" ? null : i.epsilon)) return !0
        }
        return !1
    }

    function e_(t, e, i, r, n) {
        var s = i[0], a = i[1], o = t[0], l = t[1], u = e[0], f = e[1], d = i[0] - o, P = i[1] - l, E = u - o,
            T = f - l, G = d * T - P * E;
        if (n !== null) {
    ...
    function n_(t, e) {
        for (var i = !1, r = 0, n = e.coordinates; r < n.length; r++) {
            var s = n[r];
            if (se(s, t, {ignoreEndVertices: !0}) && (i = !0), !se(s, t)) return !1
        }
        return !!i
    }
    ...
    function a_(t, e) {
        for (var i = !1, r = 0, n = e.coordinates; r < n.length; r++) {
            var s = n[r];
            if (se({type: "Point", coordinates: s}, t, {ignoreEndVertices: !0}) && (i = !0), !se({
                type: "Point",
                coordinates: s
    ...
    function xl(t) {
        ...
        return (i, r, n) => {
            let s = i.x, a = i.y, o = n.x, l = n.y,
                u = a.minus(l).times(r.x.minus(o)).minus(s.minus(o).times(r.y.minus(l)));
            return e(u, s, a, o, l) ? 0 : u.comparedTo(0)
        }
    }

    var u_ = /^-?(?:\d+(?:\.\d*)?|\.\d+)(?:e[+-]?\d+)?$/i, Zi = Math.ceil, dt = Math.floor, ht = "[BigNumber Error] ",
        wl = ht + "Number primitive has more than 15 significant digits: ", Lt = 1e14, F = 14, Wi = 9007199254740991,
        Qi = [1, 10, 100, 1e3, 1e4, 1e5, 1e6, 1e7, 1e8, 1e9, 1e10, 1e11, 1e12, 1e13], It = 1e7, tt = 1e9;

    function Cl(t) {
        var e, i, r, n = b.prototype = {constructor: b, toString: null, valueOf: null}, s = new b(1), a = 20, o = 4,
            l = -7, u = 21, f = -1e7, d = 1e7, P = !1, E = 1, T = 0, G = {
                prefix: "",
                groupSize: 3,
                ...
                suffix: ""
            }, _ = "0123456789abcdefghijklmnopqrstuvwxyz", x = !0;
        ...
        function b(h, c) {
            ...
            if (w = w.slice(C, ++v)) {
                ...
                if ((k = k - C - 1) > d) M.c = M.e = null; else if (k < f) M.c = [M.e = 0]; else {
        ...
        b.clone = Cl, b.ROUND_UP = 0, b.ROUND_DOWN = 1, b.ROUND_CEIL = 2, b.ROUND_FLOOR = 3, b.ROUND_HALF_UP = 4, b.ROUND_HALF_DOWN = 5, b.ROUND_HALF_EVEN = 6, b.ROUND_HALF_CEIL = 7, b.ROUND_HALF_FLOOR = 8, b.EUCLID = 9, b.config = b.set = function (h) {
            ...
            if (h != null) if (typeof h == "object") {
                if (h.hasOwnProperty(c = "DECIMAL_PLACES") && (p = h[c], J(p, 0, tt, c), a = p), h.hasOwnProperty(c = "ROUNDING_MODE") && (p = h[c], J(p, 0, 8, c), o = p), h.hasOwnProperty(c = "EXPONENTIAL_AT") && (p = h[c], p && p.pop ? (J(p[0], -tt, 0, c), J(p[1], 0, tt, c), l = p[0], u = p[1]) : (J(p, -tt, tt, c), l = -(u = p < 0 ? -p : p))), h.hasOwnProperty(c = "RANGE")) if (p = h[c], p && p.pop) J(p[0], -tt, -1, c), J(p[1], 1, tt, c), f = p[0], d = p[1]; else if (J(p, -tt, tt, c), p) f = -(d = p < 0 ? -p : p); else throw Error(ht + c + " cannot be zero: " + p);
                if (h.hasOwnProperty(c = "CRYPTO")) if (p = h[c], p === !!p) if (p) if (typeof crypto < "u" && crypto && (crypto.getRandomValues || crypto.randomBytes)) P = p; else throw P = !p, Error(ht + "crypto unavailable"); else P = p; else throw Error(ht + c + " not true or false: " + p);
                if (h.hasOwnProperty(c = "MODULO_MODE") && (p = h[c], J(p, 0, 9, c), E = p), h.hasOwnProperty(c = "POW_PRECISION") && (p = h[c], J(p, 0, tt, c), T = p), h.hasOwnProperty(c = "FORMAT")) if (p = h[c], typeof p == "object") G = p; else throw Error(ht + c + " not an object: " + p);
                if (h.hasOwnProperty(c = "ALPHABET")) if (p = h[c], typeof p == "string" && !/^.?$|[+\-.\s]|(.).*\1/.test(p)) x = p.slice(0, 10) == "0123456789", _ = p; else throw Error(ht + c + " invalid: " + p)
            ...
            return function (p, y, g, k, C) {
                ...
                if ($ < 0 ? --w : (I.c = N, I.e = w, I.s = k, I = e(I, K, W, U, g), N = I.c, B = I.r, w = I.e), v = w + W + 1, $ = N[v], M = g / 2, B = B || v < 0 || N[v + 1] != null, B = U < 4 ? ($ != null || B) && (U == 0 || U == (I.s < 0 ? 3 : 2)) : $ > M || $ == M && (U == 4 || B || U == 6 && N[v - 1] & 1 || U == (I.s < 0 ? 8 : 7)), v < 1 || !N[0]) p = B ? Et(m.charAt(1), -W, m.charAt(0)) : m.charAt(0); else {
            ...
            function c(y, g, k, C) {
                var m, v;
                if (k != C) v = k > C ? 1 : -1; else for (m = v = 0; m < k; m++) if (y[m] != g[m]) {
                    v = y[m] > g[m] ? 1 : -1;
                    break
                }
                return v
            ...
            return function (y, g, k, C, m) {
                var v, w, M, B, I, N, K, $, W, U, j, it, De, si, ai, bt, le, ct = y.s == g.s ? 1 : -1, st = y.c,
                    Z = g.c;
                ...
                if (Z[M] > (st[M] || 0) && w--, ct < 0) W.push(1), B = !0; else {
                    ...
                    do {
                        if (I = 0, v = c(Z, U, bt, j), v < 0) {
                            if (it = U[0], bt != j && (it = it * m + (U[1] || 0)), I = dt(it / ai), I > 1) for (I >= m && (I = m - 1), N = h(Z, I, m), K = N.length, j = U.length; c(N, U, K, j) == 1;) I--, p(N, bt < K ? le : Z, K, m), K = N.length, v = 1; else I == 0 && (v = I = 1), N = Z.slice(), K = N.length;
        ...
        function R(h, c, p, y) {
            ...
            if (g = h.c[0], C = h.e, c == null) v = ft(h.c), v = y == 1 || y == 2 && (C <= l || C >= u) ? Je(v, C) : Et(v, C, "0"); else if (h = A(new b(h), c, p), k = h.e, v = ft(h.c), m = v.length, y == 1 || y == 2 && (c <= k || k <= l)) {
                for (; m < c; v += "0", m++) ;
                v = Je(v, k)
        ...
        r = function () {
            var h = /^(-?)0([xbo])(?=\w[\w.]*$)/i, c = /^([^.]+)\.$/, p = /^\.([^.]+)$/, y = /^-?(Infinity|NaN)$/,
                g = /^\s*\+(?=[\w.])|^\s+|\s+$/g;
            return function (k, C, m, v) {
                var w, M = m ? C : C.replace(g, "");
                if (y.test(M)) k.s = isNaN(M) ? null : M < 0 ? -1 : 1; else {
        ...
        function A(h, c, p, y) {
            ...
            if (B) {
                t:{
                    ...
                    if (k = c - g, k < 0) k += F, C = c, v = B[w = 0], M = dt(v / I[g - C - 1] % 10); else if (w = Zi((k + 1) / F), w >= B.length) if (y) {
        ...
        return n.absoluteValue = n.abs = function () {
            ...
            for (m ? (p = new b(.5), v && (h.s = 1), w = Ye(h)) : (g = Math.abs(+q(h)), w = g % 2), M = new b(s); ;) {
                ...
                if (g) {
                    ...
                    w = g % 2
                } else if (h = h.times(p), A(h, h.e + 1, 1), h.e > 14) w = Ye(h); else {
                    if (g = +q(h), g === 0) break;
                    w = g % 2
                }
            ...
            var y, g = this;
            if (p == null) h != null && c && typeof c == "object" ? (p = c, c = null) : h && typeof h == "object" ? (p = h, h = c = null) : p = G; else if (typeof p != "object") throw Error(ht + "Argument not an object: " + p);
            if (y = g.toFixed(h, c), g.c) {
                var k, C = y.split("."), m = +p.groupSize, v = +p.secondaryGroupSize, w = p.groupSeparator || "",
                    M = C[0], B = C[1], I = g.s < 0, N = I ? M.slice(1) : M, K = N.length;
    ...
    var er = class {
        ...
        _delete(e) {
            ...
            if (this.size--, s == null) this.root = r.right; else {
                let a = r.right;
    ...
    var Pl = t => {
        if (t) {
            let e = new Pt(Ee(t)), i = new Pt(Ee(t)), r = (s, a) => a.addAndReturn(s),
    ...
    var nr = t => ({
        set: e => {
            ut = nr(e)
        }, reset: () => nr(t), compare: Ee(t), snap: Pl(t), orient: xl(t)
    }), ut = nr();
    var ae = (t, e) => t.ll.x.isLessThanOrEqualTo(e.x) && e.x.isLessThanOrEqualTo(t.ur.x) && t.ll.y.isLessThanOrEqualTo(e.y) && e.y.isLessThanOrEqualTo(t.ur.y),
        Pe = (t, e) => {
            ...
            let i = t.ll.x.isLessThan(e.ll.x) ? e.ll.x : t.ll.x, r = t.ur.x.isLessThan(e.ur.x) ? t.ur.x : e.ur.x,
                n = t.ll.y.isLessThan(e.ll.y) ? e.ll.y : t.ll.y, s = t.ur.y.isLessThan(e.ur.y) ? t.ur.y : e.ur.y;
            return {ll: {x: i, y: n}, ur: {x: r, y: s}}
        };
    var Ze = (t, e) => t.x.times(e.y).minus(t.y.times(e.x)), Tl = (t, e) => t.x.times(e.x).plus(t.y.times(e.y)),
        We = t => Tl(t, t).sqrt(), Rl = (t, e, i) => {
        ...
        }, Sl = (t, e, i) => e.y.isZero() ? null : {x: t.x.plus(e.x.div(e.y).times(i.minus(t.y))), y: i},
        Bl = (t, e, i) => e.x.isZero() ? null : {x: i, y: t.y.plus(e.y.div(e.x).times(i.minus(t.x)))},
        Ol = (t, e, i, r) => {
            ...
            let s = {x: i.x.minus(t.x), y: i.y.minus(t.y)}, a = Ze(s, e).div(n), o = Ze(s, r).div(n),
                l = t.x.plus(o.times(e.x)), u = i.x.plus(a.times(r.x)), f = t.y.plus(o.times(e.y)),
                d = i.y.plus(a.times(r.y)), P = l.plus(u).div(2), E = f.plus(d).div(2);
            return {x: P, y: E}
        };
    var et = class t {
        point;
    ...
    var p_ = 0, Mt = class t {
        ...
        static fromRing(e, i, r) {
            ...
            if (o < 0) n = e, s = i, a = 1; else if (o > 0) n = i, s = e, a = -1; else throw new Error(`Tried to create degenerate segment at [${e.x}, ${e.y}]`);
            let l = new et(n, !0), u = new et(s, !1);
        ...
        getIntersection(e) {
            ...
            let s = this.leftSE.point, a = this.rightSE.point, o = e.leftSE.point, l = e.rightSE.point,
                u = ae(i, o) && this.comparePoint(o) === 0, f = ae(r, s) && e.comparePoint(s) === 0,
                d = ae(i, l) && this.comparePoint(l) === 0, P = ae(r, a) && e.comparePoint(a) === 0;
        ...
        split(e) {
            let i = [], r = e.events !== void 0, n = new et(e, !0), s = new et(e, !1), a = this.rightSE;
        ...
        beforeState() {
            ...
            if (!this.prev) this._beforeState = {rings: [], windings: [], multiPolys: []}; else {
        ...
        afterState() {
            ...
            for (let o = 0, l = i.length; o < l; o++) {
                if (r[o] === 0) continue;
                let u = i[o], f = u.poly;
                if (a.indexOf(f) === -1) if (u.isExterior) s.push(f); else {
    ...
    var Qe = class {
        ...
        constructor(e, i) {
            ...
            this.polys = [], this.bbox = {
                ...
                }, ur: {x: new mt(Number.NEGATIVE_INFINITY), y: new mt(Number.NEGATIVE_INFINITY)}
            };
    ...
    var ti = class t {
        ...
        getGeom() {
            ...
            let s = this.isExteriorRing() ? 1 : -1, a = this.isExteriorRing() ? 0 : i.length - 1,
                o = this.isExteriorRing() ? i.length : -1, l = [];
        ...
        _composePolys(e) {
            ...
            for (let r = 0, n = e.length; r < n; r++) {
                let s = e[r];
                if (!s.poly) if (s.isExteriorRing()) i.push(new ei(s)); else {
    ...
    X.Cut = X.Polygon.extend({
        initialize(t) {
            ...
            Object.keys(e).map(n => e[n]).filter(n => n.pm).filter(n => !n._pmTempLayer).filter(n => !L.PM.optIn && !n.options.pmIgnore || L.PM.optIn && n.options.pmIgnore === !1).filter(n => n instanceof L.Polyline).filter(n => n !== t).filter(n => n.pm.options.allowCutting).filter(n => this.options.layersToCut && L.Util.isArray(this.options.layersToCut) && this.options.layersToCut.length > 0 ? this.options.layersToCut.indexOf(n) > -1 : !0).filter(n => !this._layerGroup.hasLayer(n)).filter(n => {
                ...
                if (l.pm.enable(n.pm.options), l.pm.disable(), n._pmTempLayer = !0, t._pmTempLayer = !0, n.remove(), n.removeFrom(this._map.pm._getContainingLayer()), t.remove(), t.removeFrom(this._map.pm._getContainingLayer()), l.getLayers && l.getLayers().length === 0 && this._map.pm.removeLayer({target: l}), l instanceof L.LayerGroup ? (l.eachLayer(u => {
            ...
            let i = L.geoJSON(), r;
            if (e instanceof L.Polygon) r = Fl(e.toGeoJSON(15), t.toGeoJSON(15)); else {
                let n = Ul(e);
                n.forEach(s => {
    ...
    X.Text = X.extend({
        initialize(t) {
            ...
            this._enabled && (this._enabled = !1, this._map.off("click", this._createMarker, this), this._hintMarker?.remove(), this._map.getContainer().classList.remove("geoman-draw-cursor"), this._map.off("mousemove", this._syncHintMarker, this), this._map.off("mousemove", this._showHintMarker, this), this._map.pm.Toolbar.toggleButton(this.toolbarButtonName, !1), this.options.snappable && this._cleanupSnapping(), this._fireDrawEnd(), this._setGlobalDrawMode())
        }, enabled() {
            return this._enabled
        }, toggle(t) {
            this.enabled() ? this.disable() : this.enable(t)
    ...
    var y_ = {
        enableLayerDrag() {
            ...
            this._layerDragEnabled = !1, Dt(this._layer) instanceof L.Canvas ? (this._layer.off("mouseout", this.removeDraggingClass, this), this._layer.off("mouseover", this.addDraggingClass, this)) : this.removeDraggingClass(), this._originalMapDragState && this._dragging && this._map.dragging.enable(), this._safeToCacheDragState = !1, this._layer.dragging && this._layer.dragging.disable();
            let t = this._getDOMElem();
            t && (Dt(this._layer) instanceof L.Canvas ? (this._layer.off("touchstart mousedown", this._dragMixinOnMouseDown, this), this._map.pm._removeTouchEvents(t)) : L.DomEvent.off(t, "touchstart mousedown", this._simulateMouseDownEvent, this)), this._layerDragged && this._fireUpdate(), this._layerDragged = !1, this._fireDragDisable()
        }, dragging() {
            ...
            let {latlng: e} = t, i = {lat: e.lat - this._tempDragCoord.lat, lng: e.lng - this._tempDragCoord.lng},
                r = n => n.map(s => {
    ...
    var b_ = {
        _onRotateStart(t) {
            this._preventRenderingMarkers(!0), this._rotationOriginLatLng = this._getRotationCenter().clone(), this._rotationOriginPoint = Gt(this._map, this._rotationOriginLatLng), this._rotationStartPoint = Gt(this._map, t.target.getLatLng()), this._initialRotateLatLng = vt(this._layer), this._startAngle = this.getAngle();
            ...
            let e = Gt(this._map, t.target.getLatLng()), i = this._rotationStartPoint, r = this._rotationOriginPoint,
            ...
            function a(f, d = [], P = -1) {
                if (P > -1 && d.push(P), L.Util.isArray(f[0])) f.forEach((E, T) => a(E, d.slice(), T)); else {
            ...
            let t = L.polygon(this._layer.getLatLngs(), {stroke: !1, fill: !1, pmIgnore: !0}).addTo(this._layer._map),
                e = t.getCenter();
    ...
    var v_ = L.Class.extend({
        includes: [Hl, Fe, Yl, Rt],
        options: {
            snappable: !0,
            snapDistance: 20,
            allowSelfIntersection: !0,
    ...
    var k_ = {
        ...
        }, _preventRenderMarkers: !1, _preventRenderingMarkers(t) {
            this._preventRenderMarkers = !!t
        }
    }, Jl = k_;
    H.Line = H.extend({
        includes: [Jl], _shape: "Line", initialize(t) {
            ...
            let e = new L.Marker(t, {draggable: !0, icon: L.divIcon({className: "marker-icon"})});
            ...
            if (!t || !e) return !1;
            let i = L.PM.Utils.calcMiddleLatLng(this._map, t.getLatLng(), e.getLatLng()), r = this._createMarker(i),
            ...
            let {indexPath: s, index: a, parentPath: o} = L.PM.Utils.findDeepMarkerIndex(this._markers, e),
            ...
            if (a.length <= 1 && (a.splice(0, a.length), s.length > 1 && r.length > 1 && (i = ve(i)), this._layer.setLatLngs(i), this._initMarkers(), u = !0), be(i) || this._layer.remove(), i = ve(i), this._layer.setLatLngs(i), this._markers = ve(this._markers), !u && (o = r.length > 1 ? (0, St.default)(this._markers, s) : this._markers, e._middleMarkerPrev && (this._markerGroup.removeLayer(e._middleMarkerPrev), this._removeFromCache(e._middleMarkerPrev)), e._middleMarkerNext && (this._markerGroup.removeLayer(e._middleMarkerNext), this._removeFromCache(e._middleMarkerNext)), this._markerGroup.removeLayer(e), this._removeFromCache(e), o)) {
                ...
                if (this.isPolygon() ? (f = (n + 1) % o.length, d = (n + (o.length - 1)) % o.length) : (d = n - 1 < 0 ? void 0 : n - 1, f = n + 1 >= o.length ? void 0 : n + 1), f !== d) {
                    let P = o[d], E = o[f];
                    this.options.hideMiddleMarkers !== !0 && this._createMiddleMarker(P, E)
                }
                o.splice(n, 1)
            }
            ...
            let e = this._layer.getLatLngs(), i = t.getLatLng(), {
                indexPath: r,
                index: n,
                parentPath: s
            ...
            let {indexPath: e, index: i, parentPath: r} = L.PM.Utils.findDeepMarkerIndex(this._markers, t),
                n = e.length > 1 ? (0, St.default)(this._markers, r) : this._markers, s = (i + 1) % n.length,
                a = (i + (n.length - 1)) % n.length, o = n[a], l = n[s];
            return {prevMarker: o, nextMarker: l}
        }, _checkMarkerAllowedToDrag(t) {
            let {prevMarker: e, nextMarker: i} = this._getNeighborMarkers(t),
                r = L.polyline([e.getLatLng(), t.getLatLng()]), n = L.polyline([t.getLatLng(), i.getLatLng()]),
            ...
            let s = i.length > 1 ? (0, St.default)(this._markers, n) : this._markers, a = (r + 1) % s.length,
                o = (r + (s.length - 1)) % s.length, l = e.getLatLng(), u = s[o].getLatLng(), f = s[a].getLatLng();
    ...
    H.Polygon = H.Line.extend({
        _shape: "Polygon", _checkMarkerAllowedToDrag(t) {
            let {prevMarker: e, nextMarker: i} = this._getNeighborMarkers(t),
                r = L.polyline([e.getLatLng(), t.getLatLng()]), n = L.polyline([t.getLatLng(), i.getLatLng()]),
                s = pt(this._layer.toGeoJSON(15), r.toGeoJSON(15)).features.length,
                a = pt(this._layer.toGeoJSON(15), n.toGeoJSON(15)).features.length;
    ...
    H.Rectangle = H.Polygon.extend({
        _shape: "Rectangle", _initMarkers() {
            ...
            let i = new L.Marker(t, {draggable: !0, icon: L.divIcon({className: "marker-icon"})});
            ...
            if (e && e.length !== 4 && e.length > 0) e.forEach((r, n) => {
                ...
                r.setLatLng(e[0])
            }); else if (!e || !e.length) console.error("The layer has no LatLngs"); else {
    ...
    H.CircleMarker = H.extend({
        _shape: "CircleMarker", initialize(t) {
    ...
    H.ImageOverlay = H.extend({
        _shape: "ImageOverlay", initialize(t) {
            this._layer = t, this._enabled = !1
        }, toggleEdit(t) {
            this.enabled() ? this.disable() : this.enable(t)
        }, enabled() {
            ...
            let t = this._layer.getBounds(), e = t.getNorthWest(), i = t.getNorthEast(), r = t.getSouthEast(),
                n = t.getSouthWest();
            return [e, i, r, n]
        }
    });
    H.Text = H.extend({
        _shape: "Text", initialize(t) {
            this._layer = t, this._enabled = !1
        }, enable(t) {
    ...
    lr.prototype = {
        transform(t) {
            ...
            let a = [[], [], []], o = this._matrix, l = [[o[0], o[2], o[4]], [o[1], o[3], o[5]], [0, 0, 1]],
                u = [[t, i, n], [e, r, s], [0, 0, 1]], f;
    ...
    var M_ = {
        calcMiddleLatLng(t, e, i) {
            ...
            return !t._pmLastGroupFetch || !t._pmLastGroupFetch.time || new Date().getTime() - t._pmLastGroupFetch.time > 1e3 ? (r(t), t._pmLastGroupFetch = {
                ...
                groups: i,
                groupIds: e
            }, {groupIds: e, groups: i}) : {groups: t._pmLastGroupFetch.groups, groupIds: t._pmLastGroupFetch.groupIds}
        }, createGeodesicPolygon: Ei, getTranslation: V, findDeepCoordIndex(t, e, i = !0) {
            let r, n = a => (o, l) => {
                let u = a.concat(l);
                if (i) {
            ...
            if (e && e.length === 2) {
                let i = this.findDeepCoordIndex(t, e[0]), r = this.findDeepCoordIndex(t, e[1]),
            ...
            let n = Gt(r, t), s = Gt(r, e), a = i * Math.PI / 180, o = Math.cos(a), l = Math.sin(a),
                u = (s.x - n.x) * o + (s.y - n.y) * l, f = (s.y - n.y) * o - (s.x - n.x) * l, d = u * o + n.x,
                P = u * l + n.y, E = -f * l + n.x, T = f * o + n.y, G = Re(r, n), _ = Re(r, {x: d, y: P}), x = Re(r, s),
                b = Re(r, {x: E, y: T});
            return [G, _, x, b]
